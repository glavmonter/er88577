...
static int boe_th101mb31ig002_dsi_probe(struct mipi_dsi_device *dsi) {
	...
	ctx->desc = desc;
	dev_warn(&dsi->dev, "Using %d lanes", dsi->lanes);
...
static int boe_th101mb31ig002_dsi_remove(struct mipi_dsi_device *dsi) {
...
static struct mipi_dsi_driver er88577_driver = {
	.driver = {
...
module_mipi_dsi_driver(er88577_driver);
